    ...
    async fn create_key(
        ...
        ops::execute(
            ...
            |state| async move {
                ...
                // A parent means this key's material is wrapped under it: there
                // is no independent key to generate, and the provider must
                // implement the configured wrapping profile or be refused.
