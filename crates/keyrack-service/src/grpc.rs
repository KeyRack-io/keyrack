...
impl KeyService for KeyServiceImpl {
    ...
    async fn encrypt(
        ...
        let ec_hash = ec
            .as_ref()
            .map_or([0u8; 32], keyrack_core::encryption_context::EncryptionContext::hash);
    ...
    async fn create_key(
        ...
        let canonical_form = keyrack_core::canon::canonicalize(
    ...
    async fn get_key(
        ...
        let lid = parse_lid(&request.into_inner().key_id)?;
        let record = self
            .state
            .storage
            .get_key(&lid)
    ...
    async fn cancel_key_deletion(
        ...
        if record.state != keyrack_core::key::KeyState::PendingDeletion {
            return Err(Status::failed_precondition(format!(
                "key is in state {} — can only cancel deletion from PendingDeletion",
                record.state
            )));
        }
    ...
    async fn list_key_versions(
        &self,
        _request: Request<proto::ListKeyVersionsRequest>,
    ) -> Result<Response<proto::ListKeyVersionsResponse>, Status> {
        Err(unimplemented("ListKeyVersions"))
    }

    async fn get_key_version(
        &self,
        _request: Request<proto::GetKeyVersionRequest>,
    ) -> Result<Response<proto::GetKeyVersionResponse>, Status> {
        Err(unimplemented("GetKeyVersion"))
    }
    ...
    async fn enable_key_rotation(
        &self,
        _request: Request<proto::EnableKeyRotationRequest>,
    ) -> Result<Response<proto::EnableKeyRotationResponse>, Status> {
        Err(unimplemented("EnableKeyRotation"))
    }

    async fn disable_key_rotation(
        &self,
        _request: Request<proto::DisableKeyRotationRequest>,
    ) -> Result<Response<proto::DisableKeyRotationResponse>, Status> {
        Err(unimplemented("DisableKeyRotation"))
    }

    async fn get_key_rotation_status(
        &self,
        _request: Request<proto::GetKeyRotationStatusRequest>,
    ) -> Result<Response<proto::GetKeyRotationStatusResponse>, Status> {
        Err(unimplemented("GetKeyRotationStatus"))
    }

    async fn get_key_rotation_history(
        &self,
        _request: Request<proto::GetKeyRotationHistoryRequest>,
    ) -> Result<Response<proto::GetKeyRotationHistoryResponse>, Status> {
        Err(unimplemented("GetKeyRotationHistory"))
    }

    async fn get_key_rotation_policy(
        &self,
        _request: Request<proto::GetKeyRotationPolicyRequest>,
    ) -> Result<Response<proto::GetKeyRotationPolicyResponse>, Status> {
        Err(unimplemented("GetKeyRotationPolicy"))
    }

    async fn set_key_rotation_policy(
        &self,
        _request: Request<proto::SetKeyRotationPolicyRequest>,
    ) -> Result<Response<proto::SetKeyRotationPolicyResponse>, Status> {
        Err(unimplemented("SetKeyRotationPolicy"))
    }
    ...
    async fn get_key_dependents(
        &self,
        _request: Request<proto::GetKeyDependentsRequest>,
    ) -> Result<Response<proto::GetKeyDependentsResponse>, Status> {
        Err(unimplemented("GetKeyDependents"))
    }

    async fn get_key_ancestors(
        &self,
        _request: Request<proto::GetKeyAncestorsRequest>,
    ) -> Result<Response<proto::GetKeyAncestorsResponse>, Status> {
        Err(unimplemented("GetKeyAncestors"))
    }
    ...
    async fn delete_alias(
        ...
        self.state
            .storage
            .delete_alias(&request.into_inner().alias_name)
            .await
            .map_err(convert::error_to_status)?;
    ...
    async fn create_hsm_connection(
        &self,
        _request: Request<proto::CreateHsmConnectionRequest>,
    ) -> Result<Response<proto::CreateHsmConnectionResponse>, Status> {
        Err(unimplemented("CreateHsmConnection"))
    }

    async fn get_hsm_connection(
        &self,
        _request: Request<proto::GetHsmConnectionRequest>,
    ) -> Result<Response<proto::GetHsmConnectionResponse>, Status> {
        Err(unimplemented("GetHsmConnection"))
    }
    ...
    async fn list_hsm_connections(
        ...
        Err(unimplemented("ListHsmConnections"))
    }

    async fn delete_hsm_connection(
        &self,
        _request: Request<proto::DeleteHsmConnectionRequest>,
    ) -> Result<Response<proto::DeleteHsmConnectionResponse>, Status> {
        Err(unimplemented("DeleteHsmConnection"))
    }

    async fn get_hsm_connection_status(
        &self,
        _request: Request<proto::GetHsmConnectionStatusRequest>,
    ) -> Result<Response<proto::GetHsmConnectionStatusResponse>, Status> {
        Err(unimplemented("GetHsmConnectionStatus"))
    }
    ...
    async fn register_namespace(
        &self,
        _request: Request<proto::RegisterNamespaceRequest>,
    ) -> Result<Response<proto::RegisterNamespaceResponse>, Status> {
        Err(unimplemented("RegisterNamespace"))
    }
    ...
    async fn list_namespaces(
        ...
        Err(unimplemented("ListNamespaces"))
    }

    async fn describe_namespace(
        &self,
        _request: Request<proto::DescribeNamespaceRequest>,
    ) -> Result<Response<proto::DescribeNamespaceResponse>, Status> {
        Err(unimplemented("DescribeNamespace"))
    }
    ...
    async fn list_rotation_jobs(
        &self,
        _request: Request<proto::ListRotationJobsRequest>,
    ) -> Result<Response<proto::ListRotationJobsResponse>, Status> {
        Err(unimplemented("ListRotationJobs"))
    }

    async fn acknowledge_rotation_job(
        &self,
        _request: Request<proto::AcknowledgeRotationJobRequest>,
    ) -> Result<Response<proto::AcknowledgeRotationJobResponse>, Status> {
        Err(unimplemented("AcknowledgeRotationJob"))
    }

    async fn complete_rotation_job(
        &self,
        _request: Request<proto::CompleteRotationJobRequest>,
    ) -> Result<Response<proto::CompleteRotationJobResponse>, Status> {
        Err(unimplemented("CompleteRotationJob"))
    }

    async fn fail_rotation_job(
        &self,
        _request: Request<proto::FailRotationJobRequest>,
    ) -> Result<Response<proto::FailRotationJobResponse>, Status> {
        Err(unimplemented("FailRotationJob"))
    }
}
